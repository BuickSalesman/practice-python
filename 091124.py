...
smaller_numbers = [number for number in numbers if number < 20]
...
big_numbers = [number for number in numbers if number >= 23]
print(big_numbers)
...
not_b_strings = [string for string in strings if string[0] != "b"]
print(not_b_strings)
