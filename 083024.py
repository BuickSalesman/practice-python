...
capitalized_salutations = [salutation.upper() for salutation in salutations]
print(capitalized_salutations)
...
salutations = ["hello", "goodbye"]
lengths = [len(salutation) for salutation in salutations]
print(lengths)
